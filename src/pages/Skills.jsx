      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-20">
          <h2 className="group inline-block text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-gray-900 mb-6 leading-tight whitespace-nowrap transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm">
            <span className="text-gray-900 transition-colors duration-200 group-hover:text-orange-600">Skills &</span>{' '}
            <span className="text-orange-600 transition-colors duration-200 group-hover:text-gray-900">Expertise</span>
          </h2>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex justify-center items-center space-x-8 mb-8">
              ...
              <div className="flex space-x-4">
                <Code className="text-orange-500 animate-pulse" size={32} />
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 hover:scale-105 transition-all duration-300 cursor-pointer">
            <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
              <Code className="text-orange-600" /> Technical Skills
            </h3>
            <div className="grid grid-cols-2 gap-4">
              {technicalSkills.map((skill, index) => (
                <div key={index} className="p-4 bg-gray-50 rounded-xl hover:bg-orange-50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group cursor-pointer border border-transparent hover:border-orange-200">
                  <skill.icon className="w-8 h-8 text-orange-600 mb-3 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300" />
                  <h4 className="font-semibold text-gray-900 group-hover:text-orange-700 transition-colors duration-300">{skill.name}</h4>
                  <p className="text-xs text-gray-500 group-hover:text-orange-600 transition-colors duration-300">{skill.level}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 hover:scale-105 transition-all duration-300 cursor-pointer">
            <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
              <Users className="text-orange-600" /> Soft Skills
            </h3>
            <div className="space-y-4">
              {softSkills.map((skill, index) => (
                <div key={index} className="flex items-center gap-4 p-3 hover:bg-gray-50 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 rounded-lg">
                  ...
                  <span className="font-medium text-gray-700 group-hover:text-orange-700 transition-colors">{skill}</span>
                </div>
              ))}
              
              <div className="mt-8 p-6 bg-orange-50 rounded-xl border border-orange-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                <div className="flex items-start gap-4">
                  <Brain className="text-orange-600 flex-shrink-0" size={24} />
